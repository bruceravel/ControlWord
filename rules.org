...
to your bag.  Return the tiles, shake the bag to mix the tiles, then
redraw to 2 less than the current hand.  So, draw back to 7 in a round
with 9 tiles, to 5 in a round with 7, or to 3 in a round with 5.  Take
one {{{color(blue,penalty tokens)}}}, then proceed with your turn.
You may redraw as many times as you like, but each subsequent draw
costs two {{{color(blue,penalty tokens)}}}.
...
{{{color(blue,penalty tokens)}}}.  That player does not loose a turn
...
{{{color(blue,penalty tokens)}}} for each unused tile.
...
Each {{{color(blue,penalty tokens)}}} counts for -3 points.
